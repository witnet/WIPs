...
1. Block candidates signed by reputed identities are prioritized over those from non-reputed identities.
2. If there are still multiple candidates, the one with the lowest VRF value is chosen.
